...
class TrainCompOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--save_every_e', type=int, default=1, help='Frequency of saving models (by epoch)')
        self.parser.add_argument('--eval_every_e', type=int, default=10, help='Frequency of animation results (by epoch)')
        self.parser.add_argument('--save_latest', type=int, default=100, help='Frequency of saving models (by iteration)')
        self.is_train = True
